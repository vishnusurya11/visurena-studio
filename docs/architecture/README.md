...
| file | what it is |
|---|---|
| [story_department.html](story_department.html) | Part one, book → screenplay: org chart of the 17 agents in `agents/` (who reports to whom), an animated walk-through of one book's run, and the roster. Open it in a browser. Published copy: https://claude.ai/artifact/6HCxs36mcpFk2TJS389QXr |
