...
def brief(story: dict, scenes: list[dict], lines: list[dict], cast: dict[str, str],
    ...
    return (
        ...
        f"is a radio play.\n\n"
        f"AT MOST TWO PEOPLE IN A BEAT. Only two faces can be held to their "
        f"reference sheets in one shot; a third is invented, and an invented face is "
        f"a different person every time it appears.\n\n"
